...
<style scoped lang="scss">
    .board-tile {
        ...
        &.tileSand {
            background-image: url("/frontend/img/board/sand.png");
        }
        &.tileBase1 {
            background-image: url("/frontend/img/board/colloseum.png");
        }
        &.tileBase2 {
            background-image: url("/frontend/img/board/temple.png");
        }
        &.tilePalm {
            background-image: url("/frontend/img/board/palm.png");
        }
        &.tileMine {
            background-image:url("/frontend/img/board/gold.png");
        }
        &:hover {
